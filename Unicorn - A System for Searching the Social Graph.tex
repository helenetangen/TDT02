...
%Data is stored so that quer can be done at index level..... and representations is based on graph properties... metadata

as long as they share similar properties with the Facebook social graph. 
